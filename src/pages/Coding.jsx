  ...
  const handleAskAI = async () => {
    ...
    try {
      const res = await fetch(API_URL, {
        method: "POST",
        headers: headers,
        body: JSON.stringify({ inputs: question, parameters: { max_new_tokens: 256, temperature: 0.7 } })
      });
        ...
        <Grid item xs={12} md={6}>
          <Select
            ...
            onChange={(e) => {
              ...
              setCode(e.target.value === "java" ? `class Code {\n  public static void main(String[] args) {\n    System.out.println("Hello, world!");\n  }\n}` : 
                e.target.value === "cpp" ? `#include <iostream>\nusing namespace std;\nint main() {\n    cout << "Hello, world!" << endl;\n    return 0;\n}` : 
                `print("Hello, world!")`);
            }}
            sx={{ mb: 2 }}
          >
