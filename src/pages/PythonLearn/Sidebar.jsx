...
const menuItems = ["Python Intro","Python Variables", 
  "Python Data Types","Python Numbers","Python Strings","Python Booleans" ,
...
>
  <Box sx={{ padding: 3 }}>
    <Typography variant="h6" fontWeight="bold">Python Tutorial</Typography>
    <List>
