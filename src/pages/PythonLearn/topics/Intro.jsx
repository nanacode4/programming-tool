  ...
  return (
    <Paper sx={{ padding: 3 }}>
      ...
      <ul>
        ...
        <li>
          <Typography>
            Used in many fields: web development, data science, AI, automation,
            etc.
          </Typography>
        </li>
        <li>
      ...
      <ul>
        <li>
          <Typography>
            Click the “Downloads” tab and choose the right version for your OS
            (Windows, macOS, or Linux).
          </Typography>
        </li>
        <li>
          <Typography>
            Use the latest stable version (e.g., Python 3.12.x).
          </Typography>
        </li>
        <li>
      ...
      <Box
        component="pre"
        sx={{ background: "#111", color: "#fff", p: 1, borderRadius: 1, mt: 1 }}
      >
        python --version
      </Box>
      ...
      <Typography>
        Let’s write a simple Python file called <code>helloworld.py</code> in
        any text editor:
      </Typography>
      ...
      <Typography>
        Save the file, open your command line, navigate to the folder where the
        file is located, and run:
      </Typography>
      <Box
        component="pre"
        sx={{ background: "#111", color: "#fff", p: 1, borderRadius: 1 }}
      >
